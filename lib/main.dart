  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GlassMenu(
      ...
      settings: LiquidGlassSettings(
        blur: 18,
        thickness: 30,
        glassColor: isDark ? const Color.fromRGBO(0, 0, 0, 0.72) : const Color.fromRGBO(255, 255, 255, 0.20),
        whitenStrength: 0.0,
        lightIntensity: isDark ? 0.05 : 0.95,
        ambientStrength: isDark ? 0.05 : 0.55,
        saturation: isDark ? 1.0 : 1.35,
        refractiveIndex: isDark ? 0.03 : 1.85,
