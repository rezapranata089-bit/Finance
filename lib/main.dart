          ...
          children: [
            ...
            Column(
              ...
              children: [
                NumberFlow(
                  value: item.amount,
                  textAlign: TextAlignValue.right,
                  locale: 'id_ID',
...
class SummaryCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(padding: const EdgeInsets.all(18), decoration: BoxDecoration(color: context.cardColor, borderRadius: BorderRadius.circular(22), border: Border.all(color: context.borderColor)), child: Row(children: [
      Expanded(child: _summary(context, Strings.t(lang, 'income'), NumberFlow(value: income, textAlign: TextAlignValue.left, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: const TextStyle(fontFamily: 'Satoshi', color: Color(0xFF24A148), fontWeight: FontWeight.bold, fontSize: 13)))),
      Container(width: 1, height: 44, color: context.borderColor),
      Expanded(child: _summary(context, Strings.t(lang, 'expense'), NumberFlow(value: expense, textAlign: TextAlignValue.left, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: const TextStyle(fontFamily: 'Satoshi', color: Color(0xFFE05270), fontWeight: FontWeight.bold, fontSize: 13)))),
      Container(width: 1, height: 44, color: context.borderColor),
      Expanded(child: _summary(context, Strings.t(lang, 'savings'), Row(mainAxisSize: MainAxisSize.min, children: [NumberFlow(value: income == 0 ? 0 : ((income - expense) / income * 100).round(), textAlign: TextAlignValue.left, style: TextStyle(fontFamily: 'Satoshi', color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold, fontSize: 13)), Text('%', style: TextStyle(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold, fontSize: 13))]))),
    ]));
  }
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              NumberFlow(value: item.amount, textAlign: TextAlignValue.right, locale: 'id_ID', format: NumberFlowFormat.currency(currencyCode: 'IDR', symbol: item.income ? '+Rp ' : '-Rp '), style: TextStyle(fontFamily: 'Satoshi', fontWeight: FontWeight.w800, fontSize: 16, color: item.income ? const Color(0xFF24A148) : context.textPrimary)),
            ]),
          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                NumberFlow(value: card.initialBalance, textAlign: TextAlignValue.left, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: TextStyle(fontFamily: 'Satoshi', color: context.textFaint, fontSize: 11)),
                              ]),
                            ],
                          ),
                        ),
                  ...
                  children: [
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 6),
                        NumberFlow(value: totalOutstanding, textAlign: TextAlignValue.left, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: TextStyle(fontFamily: 'Satoshi', color: context.textPrimary, fontWeight: FontWeight.bold, fontSize: 15)),
                      ]),
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: 6),
                          NumberFlow(value: totalInterest, textAlign: TextAlignValue.left, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: const TextStyle(fontFamily: 'Satoshi', color: Color(0xFF24A148), fontWeight: FontWeight.bold, fontSize: 15)),
                        ]),
                      ),
                    ),
                  ],
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(children: [
                                            ...
                                            NumberFlow(value: loan.remainingPrincipal, textAlign: TextAlignValue.left, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: TextStyle(fontFamily: 'Satoshi', color: context.textMuted, fontSize: 12)),
                                          ]),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Row(children: [
                                          ...
                                          NumberFlow(value: loan.currentInterest, textAlign: TextAlignValue.right, locale: 'id_ID', format: const NumberFlowFormat.currency(currencyCode: 'IDR', symbol: 'Rp '), style: TextStyle(fontFamily: 'Satoshi', color: context.textFaint, fontSize: 11, fontWeight: FontWeight.w600)),
                                        ]),
                                      ],
                                    ),
                                  ],
