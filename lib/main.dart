          ...
          Container(
            ...
            child: Stack(children: [
              ...
              children: [
                ...
                Center(child: NumberFlow(value: balance, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: TextStyle(fontSize: 38, fontWeight: FontWeight.w700, letterSpacing: -1, color: context.textPrimary))),
          ...
          children: [
            ...
            Column(
              ...
              children: [
                NumberFlow(
                  value: item.amount,
                  format: NumberFlowFormat.currency(locale: 'id_ID', symbol: item.income ? '+Rp ' : '-Rp ', decimalDigits: 0),
...
class SummaryCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(padding: const EdgeInsets.all(18), decoration: BoxDecoration(color: context.cardColor, borderRadius: BorderRadius.circular(22), border: Border.all(color: context.borderColor)), child: Row(children: [
      Expanded(child: _summary(context, Strings.t(lang, 'income'), NumberFlow(value: income, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: const TextStyle(color: Color(0xFF24A148), fontWeight: FontWeight.bold, fontSize: 13)))),
      Container(width: 1, height: 44, color: context.borderColor),
      Expanded(child: _summary(context, Strings.t(lang, 'expense'), NumberFlow(value: expense, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: const TextStyle(color: Color(0xFFE05270), fontWeight: FontWeight.bold, fontSize: 13)))),
      Container(width: 1, height: 44, color: context.borderColor),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              NumberFlow(value: item.amount, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: item.income ? '+Rp ' : '-Rp ', decimalDigits: 0), style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: item.income ? const Color(0xFF24A148) : context.textPrimary)),
            ]),
          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                NumberFlow(value: card.initialBalance, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: TextStyle(color: context.textFaint, fontSize: 11)),
                              ]),
                            ],
                          ),
                        ),
                  ...
                  children: [
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        const SizedBox(height: 6),
                        NumberFlow(value: totalOutstanding, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: TextStyle(color: context.textPrimary, fontWeight: FontWeight.bold, fontSize: 15)),
                      ]),
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          const SizedBox(height: 6),
                          NumberFlow(value: totalInterest, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: const TextStyle(color: Color(0xFF24A148), fontWeight: FontWeight.bold, fontSize: 15)),
                        ]),
                      ),
                    ),
                  ],
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(children: [
                                            ...
                                            NumberFlow(value: loan.remainingPrincipal, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: TextStyle(color: context.textMuted, fontSize: 12)),
                                          ]),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Row(children: [
                                          ...
                                          NumberFlow(value: loan.currentInterest, format: NumberFlowFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0), style: TextStyle(color: context.textFaint, fontSize: 11, fontWeight: FontWeight.w600)),
                                        ]),
                                      ],
                                    ),
                                  ],
