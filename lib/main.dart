  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GlassMenu(
      ...
      settings: LiquidGlassSettings(
        blur: 18,
        thickness: 30,
        glassColor: isDark ? const Color.fromRGBO(0, 0, 0, 0.55) : const Color.fromRGBO(255, 255, 255, 0.20),
        whitenStrength: isDark ? 0.0 : 0.16,
        lightIntensity: isDark ? 0.5 : 0.95,
        ambientStrength: isDark ? 0.24 : 0.55,
        saturation: 1.35,
        refractiveIndex: isDark ? 1.3 : 1.85,
        chromaticAberration: isDark ? 0.4 : 2.2,
      ),
      trigger: LiquidGlass(
        borderRadius: 999,
        tint: isDark ? Colors.black : null,
